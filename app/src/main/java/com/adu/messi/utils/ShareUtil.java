...
import com.adu.messi.bean.AppEntity;
import java.io.File;
...
public class ShareUtil {
    ...
    public static void sendToFriend(Context context) {
        ...
        Intent openInChooser = Intent.createChooser(intentList.remove(0), context.getString(R.string.transfer_apk_to_friend, "Messi"));
